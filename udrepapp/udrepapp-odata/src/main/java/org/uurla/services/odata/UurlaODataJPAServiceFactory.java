...
/*******************************************************************************
 * sovrascrivo la classe ODataJPAServiceFactory di olingo che non mi permette di gestire
 * le factory a mio piacimento
 ******************************************************************************/
...
public abstract class UurlaODataJPAServiceFactory extends ODataServiceFactory {
...
/** sostituisco l'ODataProcessor con una sottoclasse di ODataJPAProcessorDefault 
    ODataSingleProcessor odataJPAProcessor = accessFactory.createODataProcessor(oDataJPAContext);
**/
    ODataSingleProcessor odataJPAProcessor = new UurlaOdataSingleProcessor(oDataJPAContext);
